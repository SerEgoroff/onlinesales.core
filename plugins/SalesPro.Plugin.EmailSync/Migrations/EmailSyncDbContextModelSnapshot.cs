...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesPro.Entities.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SalesPro.Entities.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SalesPro.Entities.Promotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SalesPro.Plugin.EmailSync.Entities.ImapAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SalesPro.Plugin.EmailSync.Entities.ImapAccountFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SalesPro.Entities.Discount", b =>
                {
                    ...
                    b.HasOne("SalesPro.Entities.OrderItem", "OrderItem")
                        .WithOne("Discount")
                        .HasForeignKey("SalesPro.Entities.Discount", "OrderItemId")
                        .HasConstraintName("fk_discount_order_item_order_item_id");

                    b.HasOne("SalesPro.Entities.Promotion", "Promotion")
                        .WithMany()
            ...
            modelBuilder.Entity("SalesPro.Plugin.EmailSync.Entities.ImapAccount", b =>
                {
                    b.HasOne("SalesPro.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("SalesPro.Plugin.EmailSync.Entities.ImapAccountFolder", b =>
                {
                    b.HasOne("SalesPro.Plugin.EmailSync.Entities.ImapAccount", "ImapAccount")
                        .WithMany()
